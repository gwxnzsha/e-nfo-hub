  ...
  Widget _buildSignedIn() {
    ...
    return Column(
      ...
      children: [
        ...
        Text(_currentUser?.displayName ?? '', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 6),
        Text(_currentUser?.email ?? '', style: const TextStyle(color: Colors.black54)),
  ...
  Widget _buildSignInButton() {
    return ElevatedButton.icon(
      ...
      label: Padding(
        ...
        child: Text(_isSigning ? 'Signing in...' : 'Continue with Google', style: const TextStyle(fontSize: 16)),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: Center(
                  child: _currentUser == null ? _buildSignInButton() : _buildSignedIn(),
                ),
              ),
              if (_error != null) ...[
              ...
              TextButton(
                ...
                child: const Text('Privacy & Terms', style: TextStyle(color: Colors.black54)),
              ),
            ],
          ),
        ),
